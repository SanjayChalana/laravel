				...
				<div class="widget">
					...
					<form action="#" class="sub-form">
						<input type="text" class="form-control mb-3"
							placeholder="Subscribe Now ..."> <a href="#"
							class="btn btn-main btn-small">subscribe</a>
					</form>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-12 col-sm-12 text-left text-lg-left">
					<ul class="list-inline footer-socials">
						...
						<li class="list-inline-item"><a
							href="https://twitter.com/themefisher"><i class="ti-twitter mr-2"></i>Twitter</a></li>
						<li class="list-inline-item"><a
...
<!-- Slick Slider -->
<script
	src="{{url('frontend/plugins/slick-carousel/slick/slick.min.js')}}"></script>
<!-- Counterup -->
<script
	src="{{url('frontend/plugins/counterup/jquery.waypoints.min.js')}}"></script>
<script
	src="{{url('frontend/plugins/counterup/jquery.counterup.min.js')}}"></script>
